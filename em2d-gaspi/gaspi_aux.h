...
#define NUM_ADJ 8
enum dir {DOWN_LEFT = 0, DOWN = 1, DOWN_RIGHT = 2, LEFT = 3, RIGHT = 4, UP_LEFT = 5, UP = 6, UP_RIGHT = 7};

#define DIR_TO_CURR_SEG_ID(dir) (dir + NUM_ADJ)
#define DIR_TO_EMF_SEG_ID(dir) (dir + (2 * NUM_ADJ))
